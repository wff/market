...
(function(host){
	...
	function createCityTopHtml(){
		...
		txt1=doc.createTextNode("融科贷"),
		txt2=doc.createTextNode(""),
	...
	function addScrollEvent(proxyTag,type){
		proxyTag["on"+type]=function(e){
			...
			target=event.srcElement||event.target;
			if(target.tagName.toLowerCase()=="a"){
				var m=target.getAttribute("href").replace(/^#/,"")||"A";cityScroll(m);
			}
			stopPropagation(event);
			preventDefault(event);
		};
	...
	var citypicker={
		...
		fix:function(point){
			if(point&&typeof point==="object"){
				var left=parseInt(point.left,10)||0,top=parseInt(point.top,10)||0;
				citypicker.point={
					left:left,
					top:top
				};
